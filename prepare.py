...
def build():
    ...
    pack = {
        ...
        "constraints": {
            ...
            "max_weight_per_stock": strategy.MAX_WEIGHT,
            "max_new_per_round": strategy.MAX_NEW_PER_ROUND,
            "budget_per_stock": round(total * strategy.MAX_WEIGHT, 2),
